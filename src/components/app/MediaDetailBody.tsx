...
// Shared detail content for both the full page (/app/media_items/[id]) and the
// intercepting-route modal. Presentational only — no page chrome.
export default function MediaDetailBody({ item }: { item: MediaItem }) {
